---
title: "Peekbank Exclusions Exploration"
author: "Martin"
date: "5/2/2021"
...
Upshot: Percent missing decreases, zoners stay about the same.
...
Distribution of zoners across age
...
Appears that having a higher percentage of zoning trials in general is related to slightly lower accuracy
...
## How does "zoning" relate to age?

The "weighted age" is just a hacky workaround right now, will compute this more carefully. No particularly strong relationship though.

```{r}
#Plot relationship between percent zoner trials and accuracy
ggplot(subj_accuracy,aes(weighted_age,percent_zoner_trials, mean_accuracy,color=dataset_rename))+
  geom_point(alpha=0.2)+
  geom_smooth(method="lm",se=FALSE)
```
