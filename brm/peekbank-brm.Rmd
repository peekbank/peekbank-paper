...
<!-- MZ: next sentence is now a bit of a non-sequitur - need to maybe link these sentences a bit better -->
<!-- MZ: need to introduce looking-while-listening earlier because it is used in this and the following paragraph - maybe this kind of sentence could fit somewhere her - also for clarifying what "measuring word recognition" means -->
...
<!-- MZ: this next section is a bit repetitive with the previous schema section on trials -->
