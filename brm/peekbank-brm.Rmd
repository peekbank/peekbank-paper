...
These import templates walk researchers through each step of data processing using example datasets from Peekbank and include explanations of key decision points during data processing, explanations of how to use various helper functions available in `peekds`, and further details about the database schema.
...
Under United States regulation, all data contributed to Peekbank are considered de-identified and hence not considered "human subjects data"; hence, institional review boards should not regulate this contribution process. 
