...
In the following sections, we will begin by providing the details on the database’s scheme design, the complete importing process and the functions provided by `peekds` package. For users who are primarily interested in accessing the database can skip these details and focus on access through the peekbankr API and the web apps.
