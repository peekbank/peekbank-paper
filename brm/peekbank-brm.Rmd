...
```{r swingley_fig, fig.cap="Proportion looking at the correct referent by time from the point of disambiguation (the onset of the target noun, e.g. "apple"). Colors show the two pronunciation conditions; points give means and ranges show 95\\% confidence intervals. The dotted line shows the point of disambiguation and the dashed line shows chance performance."}
