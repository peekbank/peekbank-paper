...
%DIF DEL peekbank-brm-initial-submission.tex   Mon Mar 21 13:02:50 2022
%DIF ADD peekbank-brm.tex                      Fri Apr 15 18:50:43 2022
...
%DIF 143-156d143
%DIF < % Overwrite redefinition of paragraph and subparagraph by the default LaTeX template
%DIF < % See https://github.com/crsh/papaja/issues/292
%DIF < \makeatletter
%DIF < \renewcommand{\paragraph}{\@startsection{paragraph}{4}{\parindent}%
%DIF <   {0\baselineskip \@plus 0.2ex \@minus 0.2ex}%
%DIF <   {-1em}%
%DIF <   {\normalfont\normalsize\bfseries\itshape\typesectitle}}
%DIF < 
%DIF < \renewcommand{\subparagraph}[1]{\@startsection{subparagraph}{5}{1em}%
%DIF <   {0\baselineskip \@plus 0.2ex \@minus 0.2ex}%
%DIF <   {-\z@\relax}%
...
%DIF 169c155
%DIF < \keywords{word recognition; eye-tracking; vocabulary development; looking-while-listening; visual world paradigm; lexical processing\newline\indent Word count: 6605}
%DIF -------
\keywords{word recognition; eye-tracking; vocabulary development; looking-while-listening; visual world paradigm; lexical processing\newline\indent Word count: 7351} %DIF > 
%DIF -------
\usepackage{lineno}
...
%DIF 220c206
%DIF < \textbf{CRediT author statement.} Outside of the position of the first and the last author, authorship position was determined by sorting authors' last names in reverse alphabetical order. An overview over authorship contributions following the CRediT taxonomy can be viewed here: \url{https://docs.google.com/spreadsheets/d/e/2PACX-1vRD-LJD_dTAQaAynyBlwXvGpfAVzP-3Pi6JTDoG15m3PYZe0c44Y12U2a_hwdmhIstpjyigG2o3na4y/pubhtml}.
%DIF -------
...
\providecommand{\DIFdeltex}[1]{}                      %DIF PREAMBLE - do not show deleted
...
\DIFaddend In this paper, we introduce \emph{Peekbank}, an open database of infant and toddler eye-tracking data aimed at facilitating the study of developmental changes in children's word recognition.
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=18in,height=4.5in]{/Users/mcfrank/Projects/peekbank/peekbank-paper/brm/figures/peekbankflowchartv6} 
%DIFDELCMD < %%%
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=7.31in,height=4.5in]{/Users/mcfrank/Projects/peekbank/peekbank-paper/brm/figures/schema_3} 
%DIFDELCMD < %%%
...
\DIFaddbegin \DIFadd{Although Peekbank provides a common data format, the crux issue of populating the database is the conversion of existing datasets to this format.
...
In an effort to double check the data quality and to make sure that no errors are made in the importing script, we \DIFdelbegin \DIFdel{create a }\DIFdelend \DIFaddbegin \DIFadd{also typically perform a visual check of the import process, creating a }\DIFaddend time course plot \DIFdelbegin \DIFdel{based on our processed tables }\DIFdelend to replicate the results in the paper that first presented each dataset
\DIFdelbegin \DIFdel{as part of the import procedure.
}\DIFdelend Once this plot has been created and checked for consistency and all tables pass our validation functions, the processed dataset is ready for reprocessing into the database using the \texttt{peekbank} library.
...
To this end}\DIFdelend \DIFaddbegin \DIFadd{There is no technical obstacle to data contributors also providing an import script to facilitate contribution, though in practice creating these scripts requires familiarity with both R scripting and the specific Peekbank schema; writing a first import script can be somewhat time-consuming.
...
%DIFDELCMD < \begin{tabular}[t]{llrrlll}
%DIFDELCMD < \toprule
%DIFDELCMD < Study Citation & Dataset name & N & Mean age (mos.) & Age range (mos.) & Method & Language\\
%DIFDELCMD < \midrule
%DIFDELCMD < Adams et al., 2018 & ft\_pt & 69 & 17.1 & 13–20 & manual coding & English\\
%DIFDELCMD < Byers-Heinlein et al., 2017 & mix & 48 & 20.1 & 19–21 & eye-tracking & English, French\\
%DIFDELCMD < Casillas et al., 2017 & tseltal & 23 & 31.3 & 9–48 & manual coding & Tseltal\\
%DIFDELCMD < Fernald et al., 2013 & fmw & 80 & 20.0 & 17–26 & manual coding & English\\
%DIFDELCMD < Frank et al., 2016 & tablet & 69 & 35.5 & 12–60 & eye-tracking & English\\
%DIFDELCMD < Garrison et al., 2020 & yoursmy & 35 & 14.5 & 12–18 & eye-tracking & English\\
%DIFDELCMD < Hurtado et al., 2007 & xsectional & 49 & 23.8 & 15–37 & manual coding & Spanish\\
%DIFDELCMD < Hurtado et al., 2008 & input\_uptake & 76 & 21.0 & 17–27 & manual coding & Spanish\\
%DIFDELCMD < Mahr et al., 2015 & coartic & 29 & 20.8 & 18–24 & eye-tracking & English\\
%DIFDELCMD < Perry et al., 2017 & cowpig & 45 & 20.5 & 19–22 & manual coding & English\\
%DIFDELCMD < Pomper \& Saffran, 2016 & switchingCues & 60 & 44.3 & 41–47 & manual coding & English\\
%DIFDELCMD < Pomper \& Saffran, 2019 & salientme & 44 & 40.1 & 38–43 & manual coding & English\\
%DIFDELCMD < Potter \& Lew-Williams, unpublished & canine & 36 & 23.8 & 21–27 & manual coding & English\\
%DIFDELCMD < Potter et al., 2019 & remix & 44 & 22.6 & 18–29 & manual coding & Spanish, English\\
%DIFDELCMD < Ronfard et al., 2021 & lsc & 40 & 20.0 & 18–24 & manual coding & English\\
%DIFDELCMD < Swingley \& Aslin, 2002 & mispron & 50 & 15.1 & 14–16 & manual coding & English\\
%DIFDELCMD < Weisleder \& Fernald, 2013 & stl & 29 & 21.6 & 18–27 & manual coding & Spanish\\
%DIFDELCMD < Yurovsky \& Frank, 2017 & attword & 288 & 25.5 & 13–59 & eye-tracking & English\\
%DIFDELCMD < Yurovsky et al., 2013 & reflook\_socword & 435 & 33.6 & 12–70 & eye-tracking & English\\
%DIFDELCMD < Yurovsky et al., unpublished & reflook\_v4 & 45 & 34.2 & 11–60 & eye-tracking & English\\
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=6.94in,height=6in]{/Users/mcfrank/Projects/peekbank/peekbank-paper/brm/figures/shiny-full-window} 
%DIFDELCMD < %%%
...
\DIFdelbegin \DIFdel{Users who are interested in inspecting or reproducing the processing pipeline for a given dataset can use the respective import script (openly available on GitHub, }%DIFDELCMD < \url{https://github.com/langcog/peekbank-data-import}%%%
...
All analyses are conducted using R \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 4.1\DIFdelbegin \DIFdel{.0}\DIFdelend \DIFaddbegin \DIFadd{.1}\DIFaddend ; R Core Team \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2021)\DIFaddbegin {]}\DIFaddend \footnote{We, furthermore, used the R-packages \emph{dplyr} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 1.0.7; Wickham, François, Henry, \DIFdelbegin \DIFdel{\& }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend Müller \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2021)\DIFaddbegin {]}\DIFaddend , \emph{forcats} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 0.5.1; Wickham \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2021a)\DIFaddbegin {]}\DIFaddend , \emph{ggplot2} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 3.3.5; Wickham \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2016)\DIFaddbegin {]}\DIFaddend , \emph{ggthemes} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 4.2.4; Arnold \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2021)\DIFaddbegin {]}\DIFaddend , \emph{here} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 1.0.1; Müller \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2020)\DIFaddbegin {]}\DIFaddend , \emph{papaja} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 0.1.0.9997; Aust \DIFdelbegin \DIFdel{\& }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend Barth \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2020)\DIFaddbegin {]}\DIFaddend , \emph{peekbankr} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 0.1.1.9002; Braginsky, MacDonald, \DIFdelbegin \DIFdel{\& }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend Frank \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2021)\DIFaddbegin {]}\DIFaddend , \emph{purrr} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 0.3.4; Henry \DIFdelbegin \DIFdel{\& }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend Wickham \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2020)\DIFaddbegin {]}\DIFaddend , \emph{readr} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 2.0\DIFdelbegin \DIFdel{.2}\DIFdelend \DIFaddbegin \DIFadd{.1}\DIFaddend ; Wickham \DIFdelbegin \DIFdel{\& }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend Hester \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2021)\DIFaddbegin {]}\DIFaddend , \emph{stringr} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 1.4.0; Wickham \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2019)\DIFaddbegin {]}\DIFaddend , \emph{tibble} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 3.1\DIFdelbegin \DIFdel{.6}\DIFdelend \DIFaddbegin \DIFadd{.4}\DIFaddend ; Müller \DIFdelbegin \DIFdel{\& }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend Wickham \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2021)\DIFaddbegin {]}\DIFaddend , \emph{tidyr} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 1.1\DIFdelbegin \DIFdel{.4}\DIFdelend \DIFaddbegin \DIFadd{.3}\DIFaddend ; Wickham \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2021b)\DIFaddbegin {]}\DIFaddend , \emph{tidyverse} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 1.3.1; Wickham et al. \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2019)\DIFaddbegin {]}\DIFaddend , \emph{tinylabels} (\DIFdelbegin \DIFdel{Version 0.2.1; }\DIFdelend Barth, 2021), \emph{viridis} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 0.6\DIFdelbegin \DIFdel{.2}\DIFdelend \DIFaddbegin \DIFadd{.1}\DIFaddend ; Garnier et al. \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2021a\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{); Garnier et al. (}\DIFaddend 2021b)\DIFaddbegin {]}\DIFaddend , \emph{viridisLite} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 0.4.0; Garnier et al. \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2021b)\DIFaddbegin {]}\DIFaddend , and \emph{xtable} \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin {[}\DIFaddend Version 1.8.4; Dahl, Scott, Roosen, Magnusson, \DIFdelbegin \DIFdel{\& }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend Swinton \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{(}\DIFaddend 2019)\DIFaddbegin {]}\DIFaddend .}
...
\DIFdelbegin \DIFdel{On the other hand, this }\DIFdelend \DIFaddbegin 

\begin{Shaded}
\begin{Highlighting}[]
\DIFadd{\FunctionTok{ggplot}\NormalTok{(target\_word\_data, }
...
\caption{\label{fig:target-word-plot}\DIFaddFL{Time course plot for four well-represented target items in the Peekbank dataset, split by three age groups. Each line represents children's average looking to the target image after the onset of the target label (dashed vertical line). Error bars represent 95\% CIs.}}
\end{figure}

\DIFadd{This }\DIFaddend simple averaging approach \DIFdelbegin \DIFdel{ignores study-to-study variation (perhaps responsible for the baseline effects we see in the }\emph{\DIFdel{apple}} %DIFAUXCMD
\DIFdel{and }\emph{\DIFdel{frog}} %DIFAUXCMD
\DIFdel{items especially).
}\DIFdelend \DIFaddbegin \DIFadd{is a proof-of-concept to demonstrate some of the potential of the Peekbank dataset.
...
Even in our example in Figure \ref{fig:target-word-plot}, we see hints of this confounding -- for example, the low baseline looks to }\emph{\DIFadd{apple}} \DIFadd{may be an artifact of an attractive distractor being paired with this item in one or two studies.
}\DIFaddend In future work, we hope to introduce model-based analytic methods that use mixed effects regression to factor out study-level and individual-level variance in order to recover developmental effects more appropriately (see e.g., Zettersten et al., 2021 for a prototype of such an analysis).

\DIFdelbegin %DIFDELCMD < \begin{Shaded}
%DIFDELCMD < \begin{Highlighting}[]
%DIFDELCMD < %%%
\DIFdel{\FunctionTok{ggplot}\NormalTok{(target\_word\_data, }
       \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ t\_norm, }\AttributeTok{y =}\NormalTok{ correct, }\AttributeTok{col =}\NormalTok{ age\_group)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_line}\NormalTok{() }\SpecialCharTok{+} 
  \FunctionTok{geom\_linerange}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{ymin =}\NormalTok{ correct }\SpecialCharTok{{-}}\NormalTok{ ci, }\AttributeTok{ymax =}\NormalTok{ correct }\SpecialCharTok{+}\NormalTok{ ci), }
                 \AttributeTok{alpha =}\NormalTok{ .}\DecValTok{2}\NormalTok{) }\SpecialCharTok{+} 
...
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics{peekbank-brm_files/figure-latex/target-word-plot-1.pdf}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \label{fig:target-word-plot}%%%
...
\DIFadd{A second limitation stems from the fact that the database represents a convenience sample of data readily available to the Peekbank team, which leads the database to be relatively homogeneous in a number of key respects.
...
}\DIFaddend The current database is also limited by the relatively homogeneous background of its participants, both with respect to language (almost entirely monolingual native English speakers) and cultural background (Henrich, Heine, \& Norenzayan, 2010; Muthukrishna et al., 2020).
Increasing the diversity of \DIFdelbegin \DIFdel{participant backgrounds }\DIFdelend \DIFaddbegin \DIFadd{lab sources, participant backgrounds, }\DIFaddend and languages will expand the scope of the generalizations we can form about child word recognition\DIFaddbegin \DIFadd{, while also providing new opportunities for describing cross-lab, cross-cultural, and cross-linguistic variation}\DIFaddend .

\DIFdelbegin \DIFdel{Finally, while the }\DIFdelend \DIFaddbegin \DIFadd{Towards the goal of expanding our database, we invite researchers to contribute their data.
...
\DIFadd{While the }\DIFaddend current database is focused on studies of word recognition, the tools and infrastructure developed in the project can in principle be used to accommodate any eye-tracking paradigm, opening up new avenues for insights into cognitive development.
...
\leavevmode\DIFaddbegin \hypertarget{ref-Balota2007}{}%DIF > 
\DIFadd{Balota, D. A., Yap, M. J., Cortese, M. J., Hutchison, K. A., Kessler, B., Loftis, B., \ldots{} Treiman, R. (2007). }{\DIFadd{The English Lexicon project}}\DIFadd{. }\emph{\DIFadd{Behavior Research Methods}}\DIFadd{, }\emph{39}(3)\DIFadd{, 445--459. }\url{https://doi.org/10.3758/BF03193014}

\leavevmode\DIFaddend \hypertarget{ref-R-tinylabels}{}%
...
Lewis, M., Braginsky, M., Tsuji, S., Bergmann, C., Piccinini, P. E., Cristia, A., \& Frank, M. C. (2016). \DIFdelbegin %DIFDELCMD < {%%%
\DIFdel{A Quantitative Synthesis of Early Language Acquisition Using Meta-Analysis}%DIFDELCMD < }%%%
...
\leavevmode\DIFaddbegin \hypertarget{ref-macwhinney2000}{}%DIF > 
...
Potter, C., \& Lew-Williams, C. (unpublished). \DIFdelbegin \emph{%DIFDELCMD < {%%%
\DIFdel{Behold the canine!: How does toddlers' knowledge of typical frames and familiar words interact to influence their sentence processing?}%DIFDELCMD < }%%%
}
%DIFAUXCMD
...
Yurovsky, D., Wade, A., Kraus, A. M., Gengoux, G. W., Hardan, A. Y., \& Frank, M. C. (unpublished). \DIFdelbegin \emph{%DIFDELCMD < {%%%
\DIFdel{Developmental changes in the speed of social attention in early word learning}%DIFDELCMD < }%%%
}%DIFAUXCMD
