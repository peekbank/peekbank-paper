...
Predict proportion looking from target frequency, controlling for age. Frequency effect does not generalize across items
...
Next, we combined all frequency and AOA predictors into a single model.
