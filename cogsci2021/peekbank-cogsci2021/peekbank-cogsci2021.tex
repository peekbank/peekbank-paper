...
development in a large-scale dataset with a wide range of items, in
order estimate the item-independent growth of word recognition speed and
accuracy.
...
higher for familiar words (\emph{M} = 65.9\%, 95\% CI = {[}65\%,
66.7\%{]}, \emph{n} = 1269) than for novel words learned during the
experiment (\emph{M} = 59.3\%, 95\% CI = {[}57.8\%, 60.8\%{]}, \emph{n}
= 822).
