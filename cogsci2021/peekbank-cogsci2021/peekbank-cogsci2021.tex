...
support children's subsequent language learning and predict later
cognitive outcomes (e.g., Marchman \& Fernald, 2008). However, measuring
...
particularly thorny in child development, since the number of items that
can be tested within a single session is limited and items must be
...
specific focus on the looking-while-listening paradigm. This paper
presents an illustration of some of the key theoretical and
