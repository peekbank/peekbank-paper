...
A key facet of children's growing word knowledge is their ability to rapidly process words and link them to relevant meanings -- often referred to as word recognition. 
...
All reported results can be reproduced with analysis scripts openly available at https://github.com/langcog/peekbank-paper.
...
Especially for older children, the maximal IICs tended to be found with windows that started between 300 and 1000ms and ended between 3000 and 4000ms, windows usually reserved for younger children. 
