...
author-information: > 
    \author{{\large \bf Martin Zettersten (martincz@princeton.edu)} \\ Department of Psychology, Princeton University
    \And {\large \bf Claire Bergey (cbergey@uchicago.edu)} \\ Department of Psychology, The University of Chicago
    \AND {\large \bf Naiti S. Bhatt (naitibhatt@gmail.com)} \\ Scripps College
    \And {\large \bf Veronica Boyce (vboyce@stanford.edu)} \\ Department of Psychology, Stanford University
    \AND {\large \bf Mika Braginsky (mikabr@mit.edu)} \\ Brain and Cognitive Sciences, MIT
    \And {\large \bf Alexandra Carstensen (abcarstensen@stanford.edu)} \\ Department of Psychology, Stanford University
    \AND {\large \bf Benny deMayo (bdemayo@princeton.edu)} \\ Department of Psychology, Princeton University
    \And {\large \bf George Kachergis (kachergis@stanford.edu)} \\ Department of Psychology, Stanford University
    \AND {\large \bf Molly Lewis (mollyllewis@gmail.com)} \\ Department of Psychology, Carnegie Mellon University
    \And {\large \bf Bria Long (bria@stanford.edu)} \\ Department of Psychology, Stanford University
    \AND {\large \bf Kyle MacDonald (kylem412@gmail.com)} \\ Core Technology, McD Tech Labs
    \And {\large \bf Jessica Mankewitz (jmankewitz@stanford.edu)} \\ Department of Psychology, Stanford University
    \AND {\large \bf Stephan Meylan (smeylan@mit.edu)} \\ Brain and Cognitive Sciences, MIT \\ Psychology and Neuroscience, Duke University
    \And {\large \bf Annissa N. Saleh (ans638@nyu.edu)} \\ Department of Psychology, NYU
    \AND {\large \bf Rose M. Schneider (roschnei@ucsd.edu)} \\ Department of Psychology, UCSD
    \And {\large \bf Angeline Sin Mei Tsui (astsui@stanford.edu)} \\ Department of Psychology, Stanford University
    \AND {\large \bf Sarp Uner (sarp.uner@duke.edu)} \\ Psychology and Neuroscience, Duke University 
    \And {\large \bf Tian Linger Xu (txu@iu.edu)} \\ Psychological and Brain Sciences, Indiana University
    \AND {\large \bf Daniel Yurovsky (yurovsky@cmu.edu)} \\ Department of Psychology, Carnegie Mellon University
...
summarize_datasets <- dataset_info %>%
  ...
  mutate(
    percent_female = case_when(
      is.nan(percent_female) ~ NA_character_,
