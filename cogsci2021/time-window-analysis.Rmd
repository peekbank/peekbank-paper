...
load(here("cogsci2021/data/aoi_data_joined.Rds"))
...
write.table(mout, file=here("cogsci2021/data/time-window-results.csv"))           
...
```{r cross-validation, eval=RUN_MODELS}
cv_results <- list()
...
# all data
mout <- read.table(file=here("cogsci2021/data/time-window-results.csv"))
