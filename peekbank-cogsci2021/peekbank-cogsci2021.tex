...
conducting individual experiments. Different eyetracking methods have
different conventions for exporting and structuring data, rendering
integrating datasets originating from different labs and data sources
difficult to integrate. We developed a a common, tidy format for the
...
timepoint of a given trial. In addition to unifying the data format, we
conduct several additional pre-processing steps to facilitate analyses
across datasets, including resampling observations to a common sampling
rate (40 Hz) and normalizing time relative to the onset of the target
label.
