...
```{r age_gca, fig.env = "figure", fig.pos = "H", fig.align='center', fig.width=4, fig.height=3, set.cap.width=T, num.cols.cap=1, fig.cap = "One column image."}
