...
```{r age_gca, fig.env = "figure*", fig.pos = "", fig.align='center', fig.width="\\textwidth", set.cap.width=T, num.cols.cap=1, fig.cap = "Growth curve models of proportion target looking during the critical target window at each age range (in months)."}
