...
We expect see very low reliability in windows that start and end before target onset, and perhaps not for any windows that end within ~300 ms post-target onset.
